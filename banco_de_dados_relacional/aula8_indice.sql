...
EXPLAIN 
	SELECT * FROM usuarios WHERE email = 'pedro.lima@example.com';

EXPLAIN 
    SELECT * FROM usuarios WHERE nome = "Maria"; -- pra saber a quantia de linhas q foi executado 

CREATE INDEX idx_nome ON usuarios (nome);  -- Criando índice
